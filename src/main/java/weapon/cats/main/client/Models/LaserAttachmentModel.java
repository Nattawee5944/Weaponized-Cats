...
public class LaserAttachmentModel extends CatEntityModel<CatEntity>{

	private ModelPart cannon;
	public LaserAttachmentModel(ModelPart root) {
		super(root);
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 13).cuboid(-1.0F, 10.0F, -2.0F, 2.0F, 2.0F, 6.0F, new Dilation(0.0F))
				.uv(25, 17).cuboid(-1.5F, 9.5F, 3.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
				.uv(27, 7).cuboid(-2.0F, 9.0F, 4.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 12.0F, -10.0F, 1.5708F, 0.0F, 0.0F));

		body.addChild("cube_r1", ModelPartBuilder.create().uv(27, 7).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 11.0F, 6.0F, 0.0F, 0.0F, 0.7854F));

		body.addChild("cube_r2", ModelPartBuilder.create().uv(27, 7).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 11.0F, 6.0F, 0.0F, -0.7854F, 0.0F));

		body.addChild("cube_r3", ModelPartBuilder.create().uv(27, 7).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 11.0F, 6.0F, -0.7854F, 0.0F, 0.0F));
