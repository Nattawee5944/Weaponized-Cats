...
public class LaserCursorRenderer extends EntityRenderer<LaserCursor>{

	protected LaserCursorRenderer(Context ctx) {
		super(ctx);
	}

	@Override
	public Identifier getTexture(LaserCursor entity) {
		// TODO Auto-generated method stub
		return new Identifier(WeaponizedCats.MOD_ID,"textures/entity/laser_cursor.png");
	}
